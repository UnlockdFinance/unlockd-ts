...
describe('validateMarket', () => {
  it('should not throw for a valid repay request', () => {
    const request = { collection: '0x1750d2e6f2fb7fdd6a751833f55007cf76fbb358' as Address, tokenId: 123n }
    expect(() => validateMarket(request)).not.toThrow()
  })

  it('should throw InvalidActionRequestParams for an invalid repay request', () => {
    const request = { collection: '0x1750d2e6f2fb7fdd6a751833f55007cf76fbb358123' as Address, tokenId: 123n }
